...
import { useSearchParams } from 'next/navigation'; // <-- 2. IMPOR HOOK

export default function LoginPage() { // <-- 3. HAPUS PROPS
  
  // 4. DAPATKAN SEARCH PARAMS DENGAN HOOK
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-(--color-light-primary) to-white p-4">
      ...
      >
        ...
        <form action={login} className="space-y-6">
          ...
          {/* 5. Tampilkan pesan error dari hook */}
          {message && (
