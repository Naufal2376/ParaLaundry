// src/components/os/DashboardWrapper.tsx
"use client";
...
export default function DashboardWrapper({ children, userRole }: DashboardWrapperProps) {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-40 flex lg:hidden">
          ...
          <div className="w-14 flex-shrink-0" onClick={() => setIsSidebarOpen(false)}></div>
        </div>
      )}
